...
public class FlickrFetchr {
    ...
    public static Observable<List<Gallery>> searchGalleries(String text) {
        ...
        return galleries(params);
    }

    public static Observable<List<Gallery>> searchGalleries(Location location) {
        Log.i("FlickrFetchr", "searchGalleries");
    ...
    private static Observable<List<Gallery>> galleries(Map<String, String> params) {
        return json(params)
                .map(json -> {
                    String jsonString = json.getJSONObject("photos")
                            .getJSONArray("photo")
